      ...
      <SidebarWrapper>
        ...
        >
          ...
          >
            ...
            >             
              <Menu.Item key="namescan">
                <Link to={`${url}/namescan`}>
                  <span className="isoMenuHolder" style={submenuColor}>
                    <i className="ion-android-mail" />
                    <span className="nav-text">
                      <IntlMessages id="sidebar.newscan" />
                    </span>
                  </span>
                </Link>
              </Menu.Item>
              <Menu.Item key="scanresult">
                <Link to={`${url}/scanresult`}>
                  <span className="isoMenuHolder" style={submenuColor}>
                    <i className="ion-android-mail" />
                    <span className="nav-text">
                      <IntlMessages id="namescan.scanResult" />
                    </span>
                  </span>
                </Link>
              </Menu.Item>
              <Menu.Item key="history">
                <Link to={`${url}/history`}>
                  <span className="isoMenuHolder" style={submenuColor}>
                    <i className="ion-android-mail" />
                    <span className="nav-text">
                      <IntlMessages id="namescan.history" />
                    </span>
                  </span>
                </Link>
              </Menu.Item>
